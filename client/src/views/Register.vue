              ...
              <div v-else>
                ...
                <v-card-text v-else>
                  ...
                  <div  v-if="page_newpassword">
                    <p>Password Changed, go to Login Page</p>
                    <v-btn :to="'/'" depressed> Login </v-btn>
                  </div>
                </v-card-text>
              </div>
...
export default {
  ...
  mounted() {
    ...
    if (this.page_register){
      api = 'auth/registerCheck'
    }
    if (this.page_newpassword){
      api = 'auth/newPasswordCheck'
    }     
    this.$store.dispatch(api, { link: this.link }).then(
      () => {
  ...
  methods: {
    register: function () {
      ...
      let link = this.link;
        ...
        this.$store.dispatch(api, { password, link }).then(
        () => {
